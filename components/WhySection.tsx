...
export default function WhySection() {
  ...
  return (
    <section id="why" className="py-24 bg-[#0d0d1a] relative overflow-hidden">
      {/* Decorative lines */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-4">
            Why <span className="gradient-text">AxonEdge?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {values.map((item, i) => (
            <motion.div
              ...
              className="glass-card rounded-2xl p-8 text-center group hover:scale-[1.02] transition-all duration-300"
            >
        ...
        <motion.div
          ...
          className="rounded-2xl border border-[#386aff]/20 bg-gradient-to-r from-[#386aff]/10 to-[#6d40ff]/10 p-8 sm:p-12 text-center"
        >
          <h3 className="text-2xl sm:text-3xl font-black text-white mb-4">
            Ready to own your technology?
          </h3>
          <p className="text-[#a0a0b8] mb-6 max-w-xl mx-auto">
            Tell us what you&apos;re building. We&apos;ll help you ship it — and make sure it&apos;s yours.
          </p>
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#386aff] hover:bg-[#4f7eff] text-white font-bold rounded-xl transition-all duration-200 glow-blue hover:glow-blue-strong"
          >
